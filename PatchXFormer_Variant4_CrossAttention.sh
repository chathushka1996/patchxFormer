...
echo "=========================================="
echo "PatchXFormer Variant 4: +Cross-Attention"
echo "=========================================="
echo "Model: $model_name"
echo "Dataset: $dataset"
echo "Sequence Length: $seq_len"
echo "This variant adds Cross-Attention with exogenous features:"
...
do
  ...
  --model_id variant4_cross_attention_$model_id_name$seq_len'_'$pred_len \
  --model $model_name \
  --data custom \
  --features M \
  --seq_len $seq_len \
  ...
  echo "Results saved with model_id: variant4_cross_attention_$model_id_name$seq_len'_'$pred_len"
  echo "----------------------------------------"
done

echo ""
echo "=========================================="
echo "Variant 4 (+Cross-Attention) evaluation completed!"
echo "Check results in: ./results/variant4_cross_attention_*/"
echo "=========================================="
