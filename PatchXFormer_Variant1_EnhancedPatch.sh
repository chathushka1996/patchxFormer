...
model_name=PatchXFormer_Variant1_EnhancedPatch
seq_len=96
...
echo "=========================================="
echo "PatchXFormer Variant 1: +Enhanced Patch Embedding"
echo "=========================================="
echo "Model: $model_name"
echo "Dataset: $dataset"
echo "Sequence Length: $seq_len"
echo "This variant adds Enhanced Patch Embedding:"
echo "  ✅ EnhancedPatchEmbedding (with global token, enhanced initialization)"
echo "  ✅ Positional embedding"
echo "  ✅ Layer normalization in embedding"
...
do
  ...
  --model_id variant1_enhanced_patch_$model_id_name$seq_len'_'$pred_len \
  --model $model_name \
  --data custom \
  --features M \
  --seq_len $seq_len \
  ...
  echo "Results saved with model_id: variant1_enhanced_patch_$model_id_name$seq_len'_'$pred_len"
  echo "----------------------------------------"
done

echo ""
echo "=========================================="
echo "Variant 1 (+Enhanced Patch Embedding) evaluation completed!"
echo "Check results in: ./results/variant1_enhanced_patch_*/"
echo "=========================================="
