...
class HybridEncoderLayerWithFrequencyAndAdaptiveNorm(nn.Module):
    """Hybrid encoder layer with frequency attention and adaptive normalization"""
    def __init__(self, self_attention, cross_attention, d_model, d_ff=None,
                 dropout=0.1, activation="gelu", n_heads=8):
        super(HybridEncoderLayerWithFrequencyAndAdaptiveNorm, self).__init__()
    ...
    def forward(self, x, cross=None, x_mask=None, cross_mask=None, tau=None, delta=None):
        ...
        # No cross-attention for this variant (cross is None)
        # Cross-attention code is kept but not executed since cross=None
...
class Model(nn.Module):
    """
    PatchXFormer Variant 3: +Adaptive Normalization
    
    This variant adds Adaptive Normalization:
    ...
    def __init__(self, configs, patch_len=16, stride=8):
        ...
        # Hybrid encoder layers with frequency attention and adaptive normalization
        self.encoder = nn.ModuleList([
            HybridEncoderLayerWithFrequencyAndAdaptiveNorm(
                AttentionLayer(
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        # Kept for consistency but not passed to encoder (cross=None)
        
        # Hybrid encoder processing with frequency attention and adaptive norm (no cross-attention)
        for layer in self.encoder:
            enc_out = layer(enc_out, cross=None)  # cross=None means no cross-attention
