...
class HybridEncoderLayerWithFrequency(nn.Module):
    """Hybrid encoder layer with frequency attention but standard LayerNorm"""
    def __init__(self, self_attention, cross_attention, d_model, d_ff=None,
                 dropout=0.1, activation="gelu", n_heads=8):
        super(HybridEncoderLayerWithFrequency, self).__init__()
        ...
        # Standard normalization (not adaptive)
...
class Model(nn.Module):
    """
    PatchXFormer Variant 2: +Frequency-Enhanced Attention
    
    This variant adds Frequency-Enhanced Attention:
    ...
    def __init__(self, configs, patch_len=16, stride=8):
        ...
        # Hybrid encoder layers with frequency attention (but standard LayerNorm)
        self.encoder = nn.ModuleList([
            HybridEncoderLayerWithFrequency(
                AttentionLayer(
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        # Hybrid encoder processing with frequency attention (no cross-attention)
