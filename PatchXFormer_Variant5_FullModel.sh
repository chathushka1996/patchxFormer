...
model_name=PatchXFormer_Variant5_FullModel
seq_len=96
...
echo "=========================================="
echo "PatchXFormer Variant 5: Full Model"
echo "=========================================="
echo "Model: $model_name"
echo "Dataset: $dataset"
echo "Sequence Length: $seq_len"
echo "This is the FULL MODEL with ALL enhancements:"
...
echo "  ✅ AdaptiveNormalization (learnable adaptive normalization)"
echo "  ✅ Cross-attention with exogenous features (x_mark_enc)"
echo "  ✅ EnhancedPredictionHead with residual connections"
echo "=========================================="
...
do
  ...
  --model_id variant5_full_model_$model_id_name$seq_len'_'$pred_len \
  --model $model_name \
  --data custom \
  --features M \
  --seq_len $seq_len \
  ...
  echo "Results saved with model_id: variant5_full_model_$model_id_name$seq_len'_'$pred_len"
  echo "----------------------------------------"
done

echo ""
echo "=========================================="
echo "Variant 5 (Full Model) evaluation completed!"
echo "Check results in: ./results/variant5_full_model_*/"
echo "=========================================="
