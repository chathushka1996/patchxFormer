...
model_name=PatchXFormer_Variant3_AdaptiveNorm
seq_len=96
...
echo "=========================================="
echo "PatchXFormer Variant 3: +Adaptive Normalization"
echo "=========================================="
echo "Model: $model_name"
echo "Dataset: $dataset"
echo "Sequence Length: $seq_len"
echo "This variant adds Adaptive Normalization:"
...
do
  ...
  --model_id variant3_adaptive_norm_$model_id_name$seq_len'_'$pred_len \
  --model $model_name \
  --data custom \
  --features M \
  --seq_len $seq_len \
  ...
  echo "Results saved with model_id: variant3_adaptive_norm_$model_id_name$seq_len'_'$pred_len"
  echo "----------------------------------------"
done

echo ""
echo "=========================================="
echo "Variant 3 (+Adaptive Normalization) evaluation completed!"
echo "Check results in: ./results/variant3_adaptive_norm_*/"
echo "=========================================="
